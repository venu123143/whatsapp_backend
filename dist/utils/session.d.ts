...
declare const ses: import("express").RequestHandler<import("express-serve-static-core").ParamsDictionary, any, any, import("qs").ParsedQs, Record<string, any>>;
export declare function getSession(sessionId: string): Promise<any>;
export declare function setSession(sessionId: string, data: any): Promise<void>;
